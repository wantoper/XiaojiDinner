        ...
        <el-form ref="form" :model="form" :rules="form_rules">
            <el-form-item label="商品图片" :label-width="formLabelWidth">
                ...
                :before-upload="beforeImgUpload">
                    <img v-if="form.image" :src="'/api/download?name='+form.image" class="commodity">
            ...
            <el-form-item label="商品描述" prop="description" :label-width="formLabelWidth">
                <el-input type="textarea" maxlength="200" :autosize="{ minRows: 4, maxRows: 4 }" show-word-limit v-model.number="form.description" autocomplete="off" placeholder="请输入商品描述"></el-input>
            </el-form-item>
    ...
    submitForm (formName) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          this.$axios.post('/api/admin/dish' + url, this.form)
            .then(res => {
              if(res.data.code === 1){
                this.$message({
                type: 'success',
