<template>
    <div class="header">
        <div class="content-wrapper">
            <div class="avatar">
                <img :src="'/api/download?name='+shopInfo.shopImg" height="64" width="64" alt="">
            </div>
            <div class="shop-info">
            ...
            <div v-if="!islogin" class="user-btn" @click="login">
                <span>登录</span>
            </div>
            <div v-else class="user-btn" @click="userinfomation">
                <span>个人信息</span>
            </div>
            ...
            <div v-show="isShow" class="detail">
                <div class="detail-wrapper clearfix">
                    <div class="detail-main">
                        <img :src="'/api/download?name='+shopInfo.shopImg" width="90px" height="90px" alt="">
