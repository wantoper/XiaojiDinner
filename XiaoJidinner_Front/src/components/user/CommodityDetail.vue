        ...
        <div v-show="showFlag" class="food">
            <div class="fond-content">
                <div class="image-header">
                    <img :src="'/api/download?name='+food.image" alt="">
                ...
                <div class="contents">
                    ...
                    <template v-if="food.status">
                        <div class="cartcontrol-wrapper">
                            <CartControl :food="food"></CartControl>
                        </div>
                        <transition name="fade">
                            <div class="buy" @click.stop.prevent="addFirst($event)">加入购物车</div>
                        </transition>
                    </template>
                        <div v-else class="sold-out">已售罄</div>
                </div>
                <div class="split" v-show="food.description"></div>
